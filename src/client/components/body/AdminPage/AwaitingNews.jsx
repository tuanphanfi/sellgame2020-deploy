    ...
    render() {
        ...
        return (
            ...
            <div className="bodyNews-aNews_piece">
                ...
                <a href={"/saveonly/"+this.props.linkid}>
...
class AwaitingNews extends PureComponent {
    state={news:[{title:"", img:"", text:"", id:""}]};
    componentDidMount() {
        // console.log("Hello");
        axios.get('/api/awaitingnews').then(res => {
            var tempArr=[];
